...
/** Recovered verbatim from app/games/page.tsx at e615a03 — the revision
 *  immediately before PR #13 replaced the hub with the player-front shell.
 *  Only the component name, the Shell hubHref and the page-local route of this
 *  copy differ from that revision. */
