...
// ──────────────────────────────────────────────────────────────────
// Every build's entry HTML gets the viewport-fit script baked in at upload
// (script + rationale live in lib/game-hosting.ts). Games uploaded BEFORE
// this existed are covered at runtime instead: the /gcs proxy route injects
// the same script when it serves their HTML.
